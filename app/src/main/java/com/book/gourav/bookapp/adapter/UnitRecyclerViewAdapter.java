...
import com.book.gourav.bookapp.GetterAndSetter.Unit;

import com.book.gourav.bookapp.R;
import com.book.gourav.bookapp.activity.Main4Activity;
...
public class UnitRecyclerViewAdapter extends RecyclerView.Adapter<UnitRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
       ...
       holder.bookstatus.setVisibility(View.VISIBLE);
        ...
        Integer status=preferences.getInt(s+u.getUnit(),0);
        if(status.equals(1))
        {
